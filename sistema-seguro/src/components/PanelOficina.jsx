...
export default function PanelOficina({ cambiarVista, veNominas = false }) {
  ...
  // Las tarifas globales por hora desaparecen con el modelo de días: cada trabajador
  // cobra por la tarifa diaria de su categoria, y la de hora extra sale de ahi tambien.
